...
public class RestaurantListByTag extends AppCompatActivity {
    ...
    public  void selectListByTag(String tagName){
        RemoteService remoteService = ServiceGenerator.createService(RemoteService.class);
        Call<ArrayList<RestaurantItem>> call = remoteService.getRestaurantByTag(tagName);
        Log.d("test",call.toString());
        final Intent intent = new Intent(getApplicationContext(),RestaurantListByTag.class);
